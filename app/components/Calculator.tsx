      ...
      <header className="bg-white border-b border-[#E5E7EB] sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-bold text-xl tracking-tight text-[#006837]">
              ...
              {filteredProducts.map((product) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-xs font-mono text-[#6B7280] mt-1">{product.bv} BV</p>
                  </div>
                  <button
                    ...
                    >
                      <div className="flex-1 min-w-0 pr-4">
                        ...
                        <p className="text-xs text-[#6B7280] font-mono">
                          {item.bv} BV × {item.quantity} ={' '}
                          {(item.bv * item.quantity).toFixed(1)} BV
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
            ...
            <div className="space-y-4 pt-6 border-t border-[#F3F4F6]">
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <p className="text-4xl font-black text-[#1F2937] font-mono leading-none">
                    {totalBV.toFixed(1)}{' '}
                    <span className="text-lg font-bold text-[#006837]">BV</span>
                  </p>
                </div>
                <div className="text-right">
                  ...
                  <p className="text-lg font-bold text-[#4B5563] font-mono">{threshold} BV</p>
                </div>
              </div>
              ...
              <div className="h-3 bg-[#F3F4F6] rounded-full overflow-hidden">
                <motion.div
                  initial={{ width: 0 }}
                  animate={{
                    width: `${Math.min(100, (totalBV / threshold) * 100)}%`,
                  }}
